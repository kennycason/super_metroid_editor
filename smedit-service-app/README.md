...
The Patch Toggles section includes common convenience patches like Skip Ceres + intro, Ceres escape timer, Quick item fanfares, Energy-free shinesparks, Enable moonwalk, the mutually exclusive Directional and Hold Aim Down Spider Ball variants, and Bomb tuning. Ceres timer exposes minutes and seconds, Bomb tuning exposes max active bombs, fuse frames, cooldown frames, and explosion delay, and either Spider Ball variant exposes room, x/y coordinates, and visible/Chozo/hidden placement type.
